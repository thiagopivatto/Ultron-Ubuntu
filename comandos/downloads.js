        ...
        switch(command){      
            case "!play":
                ...
                try{
                    ...
                    if(videoInfo.duration > 1200000) return await client.reply(from, msgs_texto.downloads.play.limite, id)
            ...
            case "!yt":
                ...
                try{
                    ...
                    if (videoInfo.duration > 1200000) return await client.reply(from,msgs_texto.downloads.yt.limite,id)
