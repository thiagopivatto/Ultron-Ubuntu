    ...
    try{
        ...
        switch(command){
            ...
            case '!entrargrupo':
                ...
                if (totalGrupos.length > 100) return await client.reply(from, msgs_texto.admin.entrar_grupo.maximo_grupos, id)
            ...
            case "!membroinfo":
                ...
                if (mentionedJidList.length > 1) return await client.reply(from, msgs_texto.admin.membroinfo.apenas_um, id)
                var respostaTexto = criarTexto(msgs_texto.admin.membroinfo.resposta)
                await client.reply(from, respostaTexto)
                break
        }
    } catch(err){
        throw err
