...
|- *!noticiasus* - Obtem noticias atuais dos Estados Unidos.
...
|-- ☾ ADMINISTRATIVO ☽
|
|- *!add* +55 (11) 9xxxx-xxxx - Adiciona ao grupo.
...
|- *!top* [qtde] [tema] - Ranking dos Top X com o tema que você escolher.
|- *!par* @pessoa1 @pessoa2 - Mede o nivel de compatibilidade entre 2 pessoas.
|- *!trisal* @pessoa1 @pessoa2 @pessoa3 - Mede o nivel de compatibilidade entre 3 pessoas.
|- *!simi* 0 ou 1 - Ativa ou desativa o SimSimi.
|
╰╼❥ ${process.env.NOME_BOT.trim()}® by *${process.env.NOME_ADMINISTRADOR.trim()}*`
        } else {
            return `__| ☾ *🤖 ${process.env.NOME_BOT.trim()}®* ☽ 
...
|- *!membroinfo* @usuario  - Mostra as informações do usuário: IP, país, estado e cidade.
|
|-- ☾ CONTROLE/LIMITE ☽
|
