const msgs_texto = {
    ...
    info: {
        ...
        info:{
            ...
            "*Versão atual* : {p6}\n"+
            "*GitHub* : https://github.com/thiagopivatto/Ultron-Ubuntu\n"
        },
        meusdados:{
    ...
    utilidades:{
        ...
        noticiasus: {
            indisponivel: "[❗] Este comando está indisponível no momento.",
            erro_servidor: '[❗] Houve um erro na API de notícias, verifique se a chave API está configurada corretamente.',
            resposta_titulo: "〘🗞️ ULTIMAS NOTÍCIAS US 〙\n\n",
            resposta_itens: "➥ 📰 *{p1}* \n" +
                "*Descrição* : {p2}\n" +
                "*Link* : {p3}\n\n"
        },
        ...
        ddi: {
            nao_encontrado: "[❗] Este DDI não foi encontrado, certifique-se que ele é válido.",
            erro_servidor: "[❗] Houve um erro para obter dados sobre este DDI, tente novamente mais tarde.",
            resposta: " 🏳 País : *{p1}*"
        },
        //clima:{
        ...
        acao: {
        erro_servidor: "[❗] Houve um erro na API de pesquisa",
        sem_resultados: "[❗] Não foi encontrado resultados para este ativo.",
        resposta: "📈 CONSULTA DE COTAÇÕES 📈\n\n" +
        "*Ticker:* {p1}\n" +
        "*Nome da Empresa:* {p2}\n" +
        "*CNPJ:* {p3}\n" +
        "*Descrição:* {p4}\n" +
        "*Preço:* {p5}\n" + 
        "*Moeda de Referência:* {p6}\n" + 
        "*Variação:* {p7}%\n" + 
        "*Última Atualização:* {p8}\n"
        }
    },
    grupo: {
        regras:{
        ...
        topativos:{
            ...
            limite_qtd: "[❗] A quantidade de pessoas deve ser entre 3 e 50",
            erro_contador: "[❗] Este comando só funciona quando o contador está ativado.",
    ...
    diversao: {
        ...
        roletarussa:{
            ...
            resposta: "🔫 Você foi o escolhido @{p1}, BANIDO!!"
        },
        casal:{
        ...
        falae: {
            resposta: "{p1}",
            erro_servidor: "[❗] Houve um erro do servidor."
        }
    },
    admin: {
        entrar_grupo:{
        ...
        membroinfo: {
            resposta: "🖥🧑 Informações do Membro 🧑🖥️\n\n" +
            "*IP*: {p1}\n" +
            "*País*: {p2}\n" +
            "*Estado*: {p3}n" +
            "*Cidade*: {p5}",
            apenas_um: "Selecione apenas um membro.",
            erro_membroinfo: "Erro na API de informação de membros."
        }
    },
    permissao: {
